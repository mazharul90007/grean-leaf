...
router.post("/", fileUploadrer.upload.single("file"), (req, res, next) => {
...
router.delete("/:id", auth(UserRole.SUPER_ADMIN, UserRole.ADMIN), specialtiesController.deleteSpecialtiesById);
