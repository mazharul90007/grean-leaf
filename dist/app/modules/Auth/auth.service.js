...
const forgetPassword = async (payload) => {
    ...
    const resetPassToken = jwtHelpers.generateToken({ email: userData.email, role: userData.role }, config.jwt.reset_pass_secret, config.jwt.reset_pass_secret_expires_in);
